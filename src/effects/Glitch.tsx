...
import { ForwardRefExoticComponent, useMemo, useImperativeHandle, forwardRef, useLayoutEffect } from 'react'
...
export const Glitch: ForwardRefExoticComponent<GlitchEffect> = forwardRef(({ active, ...props }: GlitchProps, ref) => {
