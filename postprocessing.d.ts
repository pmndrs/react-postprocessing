...
declare module 'postprocessing' {
   ...
   */
  export type EdgeDetectionMode = {
    DEPTH: number
    LUMA: number
    COLOR: number
  }

  export interface EffectMaterial extends Resizable {}
   ...
   * @param [options.resolutionScale = 0.5] - Deprecated. Adjust the height or width instead for consistent results.
  ...
  export class BlurPass {
    constructor(options?: { resolutionScale?: number; width?: number; height?: number; kernelSize?: KernelSize })
    /**
   ...
   * @param camera - The camera to use to render the scene.
   * @param [options] - The options.
   * @param [options.resolutionScale = 1.0] - Deprecated. Adjust the height or width instead for consistent results.
  ...
  export interface Effect extends Initializable, Resizable, Disposable {}
   ...
   * @param [options.resolutionScale = 0.5] - Deprecated. Use height or width instead.
   ...
   */
  export class ColorAverageEffect {
   ...
   */
  export class GammaCorrectionEffect {
  ...
  export class GridEffect {
    constructor(options?: { blendFunction?: BlendFunction; scale?: number; lineWidth?: number })
    /**
   ...
   * @param [options.aspectCorrection = false] - Deprecated. Enable uvTransform instead and adjust the texture's offset, repeat and center.
   */
  export class TextureEffect {
    constructor(options?: { blendFunction?: BlendFunction; texture?: Texture; aspectCorrection?: boolean })
    /**
     * The texture.
     */
    texture: Texture
  ...
  export class SMAAImageLoader {
     ...
     */
    load(onLoad?: (...params: any[]) => any, onError?: (...params: any[]) => any): Promise
  }
